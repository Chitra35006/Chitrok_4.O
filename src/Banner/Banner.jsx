      ...
      <section className={`flex flex-col md:flex-row items-center justify-center ${theme === "dark" ? "bg-gradient-to-r from-slate-950 via-purple-600 to-slate-700" : "bg-gradient-to-r from-violet-950 via-purple-600 to-orange-900"} text-white py-16 px-8`}>
        ...
        >
          ...
          >
            ...
            <motion.div
              className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-full bg-black text-white px-3 py-1 rounded-md text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300"
            >
              Chitra Rani Das
            </motion.div>
          </motion.div>
